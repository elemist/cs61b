...
public class DList {
  ...
  public DListNode prev(DListNode node) {
    // Your solution here.
      if (size == 0 || node == null|| node.prev == head) return null;
      return node.prev;
  }
  ...
  public void insertAfter(Object item, DListNode node) {
    // Your solution here.
      if (node == null) return;
      DListNode aNode = newNode(item,node,node.next);
      node.next.prev = aNode;
      node.next = aNode;
      size++;
  }
  ...
  public void insertBefore(Object item, DListNode node) {
    // Your solution here.
      if (node == null) return;
      DListNode bNode = newNode(item,node.prev,node);
      node.prev.next = bNode;
      node.prev = bNode;
      size++;
  }
