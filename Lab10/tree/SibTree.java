...
public class SibTree extends Tree {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      r3 = r.child(3);
      //
      System.out.println(r2.item + " r2 should be 12");
      System.out.println(r3.item + " r3 should be 13");
      System.out.println(r2.nextSibling().item +"should be 13");
      //
      ...
      r32 = r3.child(2);
      //
      System.out.println(r31.item +" should be 131");
      System.out.println(r32.item +" should be 132");
      //
    ...
    //
    System.out.println("The tree looks like this: [1 12 13 131 132]");
    System.out.print(t.toString());
    //
    try {
      r1 = r.child(1);
    ...
    ///
    System.out.println("The tree  should look like this: [1 12 13 131]");
    System.out.print(t.toString());
    ////
    if (t.size() != 4) {
      System.out.println("  ERROR:  tree size is " + t.size() +
