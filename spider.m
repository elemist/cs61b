...
% Yuan:
% spider([1 1.04 1.43 1.65; 0.9 0.8 0.98 0.77; .7 .8 .9 1.10; 1.10 1.11 0.92 0.93; 0.93 1.04 1.05 1.16],'test plot',[0 1.8], {'Flap';'Tower';'Activity';'power';'jk'},{'Case 1' 'Case 2' 'Case 3' 'Case 4'});
