...
public class SList {
  ...
  public void insertEnd(Object obj) {
    if (head == null) {
      ...
      SListNode node = head;//locate to the last one
  ...
  public void twin() {
    // Fill in your solution here.  (Ours is seven lines long.)
      ...
      while (cNode.next != null){
          SListNode twinNode = new SListNode(cNode.item,cNode.next);
          cNode.next = twinNode;
          cNode = twinNode.next; 
      }  
      cNode.next = new SListNode(cNode.item,null);
     // insertEnd(cNode.item);
