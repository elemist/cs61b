...
%     modified 3/23/2015 by Yuan Yuan
%--------------------------------------------------------------------------

%--------------------------------------------------------------------------
%open the FAST input file
%--------------------------------------------------------------------------
%%change .fst every time ,change the blade.dat if stiffness changes
input_fast='OnshoreGen_MPC_18mps.fst';
% input_fast='Onshore_Frost.fst';
% input_fast='OnshoreGen_15mps.fst';
